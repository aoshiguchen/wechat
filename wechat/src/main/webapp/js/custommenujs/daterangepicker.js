...
!function ($) {
    ...
    var DateRangePicker = function (element, options, cb) {
        ...
        var DRPTemplate = '<div class="daterangepicker dropdown-menu" style="left: auto; right: 0; top: 136.81817626953125px;">' +
    ...
    DateRangePicker.prototype = {
        ...
        renderCalendar: function (calendar, selected, minDate, maxDate) {
            ...
            if (!minDate || minDate.isBefore(calendar[1][1])) {
                html += '<th class="prev available"><i class="icon-arrow-left fa fa-chevron-left"></i></th>';
            } else {
                html += '<th></th>';
            }
            ...
            if (!maxDate || maxDate.isAfter(calendar[1][1])) {
                html += '<th class="next available"><i class="icon-arrow-right fa fa-chevron-right"></i></th>';
            } else {
                html += '<th></th>';
            }
            ...
            for (var row = 0; row < 6; row++) {
                ...
                for (var col = 0; col < 7; col++) {
                    ...
                    if ((minDate && calendar[row][col].isBefore(minDate)) || (maxDate && calendar[row][col].isAfter(maxDate))) {
                        cname = ' off disabled ';
                    } else if (calendar[row][col].format('YYYY-MM-DD HH:mm:ss') == selected.format('YYYY-MM-DD HH:mm:ss')) {
                        cname += ' active ';
                        if (calendar[row][col].format('YYYY-MM-DD HH:mm:ss') == this.startDate.format('YYYY-MM-DD HH:mm:ss')) {
                            cname += ' start-date ';
                        }
                        if (calendar[row][col].format('YYYY-MM-DD HH:mm:ss') == this.endDate.format('YYYY-MM-DD HH:mm:ss')) {
                            cname += ' end-date ';
                        }
