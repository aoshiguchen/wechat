...
dsy.add("0_1", [ "东城", "丰台","大兴","密云","平谷","延庆","怀柔","房山","昌平","朝阳","海淀","石景山","西城","通州","门头沟","顺义"  ]);
...
dsy.add("0_2_8", [ "长泰县", "东山县", "华安县", "龙海市", "南靖县", "平和县", "云霄县", "漳浦县",
		"漳州市", "诏安县" ]);
dsy.add("0_3", [ "白银", "定西", "甘南", "嘉峪关", "金昌", "酒泉", "兰州市", "临夏",
		"陇南", "平凉", "庆阳", "天水", "武威", "张掖" ]);
...
dsy.add("0_6", [ "安顺", "毕节", "贵阳", "六盘水", "黔东南", "黔南",
		"黔西", "铜仁", "遵义" ]);
...
dsy.add("0_7", [ "白沙", "保亭", "昌江", "澄迈", "定安", "东方", "海口",
		"乐东", "临高", "陵水", "琼海", "琼中", "三亚", "屯昌", "万宁",
		"文昌", "五指山", "儋州" ]);
...
dsy.add("0_11", [ "鄂州", "恩施", "黄冈", "黄石", "荆门", "荆州", "潜江", "神农架",
...
dsy.add("0_11_16", [ "长阳土家族自治县", "当阳市", "五峰土家族自治县", "兴山县", "宜昌市", "宜都市", "远安县",
		"枝江市", "秭归县" ]);
dsy.add("0_12", [ "常德", "长沙", "郴州", "衡阳", "怀化", "娄底", "邵阳", "湘潭", "湘西",
		"益阳", "永州", "岳阳", "张家界", "株洲" ]);
...
dsy.add("0_13", [ "白城", "白山", "长春", "吉林", "辽源", "四平", "松原", "通化", "延边" ]);
...
dsy.add("0_17", [ "阿拉善", "巴彦淖尔", "包头", "赤峰", "鄂尔多斯", "呼和浩特", "呼伦贝尔", "通辽",
		"乌海", "乌兰察布", "锡林郭勒", "兴安" ]);
...
dsy.add("0_18", [ "固原", "石嘴山", "吴忠", "银川", "中卫" ]);
dsy.add("0_18_0", [ "固原市", "隆德县", "彭阳县", "西吉县", "泾源县" ]);
dsy.add("0_18_1", [ "惠农县", "平罗县", "石嘴山市", "陶乐县" ]);
dsy.add("0_18_2", [ "青铜峡市", "同心县", "吴忠市", "盐池县" ]);
dsy.add("0_18_3", [ "贺兰县", "灵武市", "银川市", "永宁县" ]);
dsy.add("0_18_4", [ "中宁县", "中卫县", "海原县" ]);
dsy.add("0_19", [ "果洛", "海北", "海东", "海南", "海西",
		"黄南", "西宁", "玉树" ]);
...
dsy.add("0_22_9", [ "定边县", "府谷县", "横山县", "佳县", "靖边县", "米脂县", "清涧县", "神木县",
		"绥德县", "吴堡县", "榆林市", "子洲县" ]);
dsy.add("0_23", [ "浦东新区","徐汇","长宁","普陀","闸北","虹口","杨浦","黄浦","卢湾","静安","宝山","闵行","嘉定","金山","松江","青浦","南汇","奉贤" ]);
...
dsy.add("0_25", [ "和平", "河东", "河西", "南开", "河北", "红桥", "滨海新区", "汉沽", "大港", "东丽", "西青", "北辰", "津南", "武清", "宝坻","静海", "宁河"," 蓟县"]);
...
dsy.add("0_26_6", [ "措美县", "错那县", "贡嘎县", "加查县", "浪卡子县", "隆子县", "洛扎县", "乃东县",
		"琼结县", "曲松县", "桑日县", "扎囊县" ])
dsy.add("0_27", [ "阿克苏", "阿拉尔", "巴音郭楞", "博尔塔拉", "昌吉", "哈密",
		"和田", "喀什", "克拉玛依", "克孜勒苏", "石河子", "图木舒克", "吐鲁番", "乌鲁木齐", "五家渠",
		"伊犁" ]);
...
dsy.add("0_28", [ "保山", "楚雄", "大理", "德宏", "迪庆",
		"红河", "昆明", "丽江", "临沧", "怒江", "曲靖", "思茅", "文山",
		"西双版纳", "玉溪", "昭通" ]);
...
dsy.add("0_30", [  "渝中","大渡口","江北","沙坪坝","九龙坡","南岸", "北碚", "綦江", "双桥", "渝北", "巴南", "万州",
                   "涪陵", "黔江", "长寿", "江津", "合川", "永川","南川", "大足", "垫江", "丰都", "奉节", "合川", "江津", "开县",
           		"梁平", "彭水", "荣昌", "石柱", "铜梁", "巫山", "巫溪",
        		"武隆", "秀山", "酉阳", "云阳", "忠县", "潼南",
        		"璧山县", "綦江县"]);
